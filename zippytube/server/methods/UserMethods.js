...
class UserMethods {
    ...
    /* registerUser method creates a new document in the users
    ...
    // retrieve user document that has a matching username
    ...
    // retrieve given user's uploaded videos
    ...
    /* store newly uploaded profile image's url (in the S3 bucket)
    to the user's profile_url attribute */
